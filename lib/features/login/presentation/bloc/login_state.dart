...
class LoginState extends Equatable {
  /// {@macro login_state}
  const LoginState({this.customProperty = 'Login Page'});
  ...
  LoginState copyWith({String? customProperty}) {
    return LoginState(customProperty: customProperty ?? this.customProperty);
  }
}
