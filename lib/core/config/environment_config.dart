...
class EnvironmentConfig {
  ...
  static const Map<String, dynamic> _localVariables = {apiUrlKey: ""};

  static const Map<String, dynamic> _testVariables = {apiUrlKey: ""};

  static const Map<String, dynamic> _prodVariables = {apiUrlKey: ""};
}
